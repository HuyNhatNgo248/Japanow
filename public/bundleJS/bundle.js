    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return require("_bundle_loader")(require.resolve("./controllers/overviewController.js"));
        case 4:
          _context.next = 6;
          return require("_bundle_loader")(require.resolve("./controllers/accordionController.js"));
        case 6:
          _context.next = 8;
          return require("_bundle_loader")(require.resolve("./controllers/searchBarController.js"));
        case 8:
          _context.next = 23;
          break;
        case 10:
          ...
          _context.next = 13;
          return require("_bundle_loader")(require.resolve("./controllers/hotelsController.js"));
        case 13:
          _context.next = 15;
          return require("_bundle_loader")(require.resolve("./controllers/accordionController.js"));
        case 15:
...
load();
},{"_bundle_loader":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-loader.js","./controllers/overviewController.js":[["overviewController.fd18a7e2.js","controllers/overviewController.js"],"overviewController.fd18a7e2.js.map","controllers/overviewController.js"],"./controllers/accordionController.js":[["accordionController.022aeeb0.js","controllers/accordionController.js"],"accordionController.022aeeb0.js.map","controllers/accordionController.js"],"./controllers/searchBarController.js":[["searchBarController.4cca437a.js","controllers/searchBarController.js"],"searchBarController.4cca437a.js.map","controllers/searchBarController.js"],"./controllers/hotelsController.js":[["hotelsController.e9a0b2ac.js","controllers/hotelsController.js"],"hotelsController.e9a0b2ac.js.map","controllers/hotelsController.js"]}],"../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
exports.Axios = Axios;
},{"./lib/axios.js":"../node_modules/axios/lib/axios.js"}],"helpers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.goToPage = exports.getPosition = exports.catchAsync = exports.AJAX = void 0;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(method, url) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          pro = _context.sent;
          return _context.abrupt("return", pro.data.data);
        case 7:
          _context.prev = 7;
...
var catchAsync = function catchAsync(fn) {
  return function () {
    return fn.apply(this, arguments).catch(function (err) {
...
exports.MAPBOX_ACCESS_TOKEN = exports.LIMIT_POIS = exports.LIMIT_FORWARD_GEOCODE = exports.DEFAULT_SORT = exports.DEFAULT_REGION = exports.DEFAULT_PROPERTY_SKELETON = exports.DEFAULT_PROPERTIES_LIMIT = exports.DEFAULT_MIN_DIST = exports.DEFAULT_MAX_DIST = exports.DEFAULT_MAP_LOCATION = exports.DEFAULT_CITIES = exports.DEFAULT_ACTIVITIES = void 0;
var MAPBOX_ACCESS_TOKEN = "pk.eyJ1Ijoibm5oeXUyNDgiLCJhIjoiY2xlYXdtbnhvMGxqcjN2cG5rdmY5cHd1ayJ9.4NE1Bp168JUT02pR7W1_Ww";
exports.MAPBOX_ACCESS_TOKEN = MAPBOX_ACCESS_TOKEN;
var LIMIT_FORWARD_GEOCODE = 5;
exports.LIMIT_FORWARD_GEOCODE = LIMIT_FORWARD_GEOCODE;
var LIMIT_POIS = 5;
exports.LIMIT_POIS = LIMIT_POIS;
...
exports.DEFAULT_MAP_LOCATION = DEFAULT_MAP_LOCATION;
var DEFAULT_SORT = "Hotel-class";
exports.DEFAULT_SORT = DEFAULT_SORT;
var DEFAULT_REGION = "Tokyo";
exports.DEFAULT_REGION = DEFAULT_REGION;
var DEFAULT_MIN_DIST = 0; //km
exports.DEFAULT_MIN_DIST = DEFAULT_MIN_DIST;
var DEFAULT_MAX_DIST = 50; //km
exports.DEFAULT_MAX_DIST = DEFAULT_MAX_DIST;
var DEFAULT_PROPERTIES_LIMIT = 30;
exports.DEFAULT_PROPERTIES_LIMIT = DEFAULT_PROPERTIES_LIMIT;
var DEFAULT_PROPERTY_SKELETON = 7;
exports.DEFAULT_PROPERTY_SKELETON = DEFAULT_PROPERTY_SKELETON;
var DEFAULT_ACTIVITIES = new Map([["shrine", "⛩️"], ["castle", "🏯"], ["bullet train", "🚄"], ["ramen", "🍜"], ["onsen monkey", "🌊"], ["cherry blossom", "🌸"], ["snow", "❄️"]]);
exports.DEFAULT_ACTIVITIES = DEFAULT_ACTIVITIES;
var DEFAULT_CITIES = new Map([["tokyo", "offers a seemingly unlimited choice of shopping, entertainment, culture and dining to its visitors. The city's history can be appreciated in districts such as Asakusa and in many excellent museums, historic temples and gardens..."], ["osaka", "is also the city of comedy. With comedy styles such as manzai originating in Osaka and gaining popularity throughout the rest of the country, Osaka is known as the city with the friendliest and funniest people in Japan..."], ["kyoto", "attracts millions of local and international visitors each year looking for traditional Japanese culture. Temples and shrines such as Kiyomizudera Temple and Kinkakuji draw lots off attention from visitors..."], ["nagoya", "is a city of some 2000 temples and shrines: a city of true masterpieces of religious architecture, such as the retina-burning splendor of Kinkaku-ji and the cavernous expanse of Higashi Hongan-ji..."], ["sapporo", ", capital of the mountainous northern Japanese island of Hokkaido, is famous for its beer, skiing and annual Sapporo Snow Festival featuring enormous ice sculptures..."], ["yokohama", ", is the first harbor city introduced to the world as the entrance to Japan. Since the time its port was opened, Yokohama has been vigorously acquiring new cultures and information from foreign countries..."], ["kobe", "is a city on Osaka Bay in central Japan. It is known for its signature marbled beef and scenic setting of mountains framing the harbor. The Ikuta Shrine, dating to the 3rd century, is among Japan's oldest Shinto shrines..."]]);
exports.DEFAULT_CITIES = DEFAULT_CITIES;
...
exports.getRegions = exports.getProperties = exports.getPointsOfInterestDetails = exports.getPointsOfInterest = exports.getMostPopulatedCities = exports.getActivitiesImages = void 0;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var getActivitiesImages = (0, _helpers.catchAsync)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(arr) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          return _context.abrupt("return", (0, _helpers.AJAX)("get", "/api/v1/overview/images/things-to-do/".concat(arr.toString())));
        case 1:
        case "end":
          return _context.stop();
      }
...
exports.getActivitiesImages = getActivitiesImages;
var getMostPopulatedCities = (0, _helpers.catchAsync)( /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(cities) {
    var data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0, _helpers.AJAX)("get", "/api/v1/overview/images/biggiest-cities/".concat(cities.toString()));
        case 2:
          data = _context2.sent;
...
exports.getMostPopulatedCities = getMostPopulatedCities;
var getPointsOfInterest = (0, _helpers.catchAsync)( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 3;
          return (0, _helpers.AJAX)("get", "/api/v1/overview/points-of-interest/attractions/attractions/".concat(lat, ",").concat(lng));
        case 3:
          data = _context3.sent;
...
var getPointsOfInterestDetails = (0, _helpers.catchAsync)( /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(locationId) {
    var data;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return (0, _helpers.AJAX)("get", "/api/v1/overview/points-of-interest/details/".concat(locationId));
        case 2:
          data = _context4.sent;
...
exports.getPointsOfInterestDetails = getPointsOfInterestDetails;
var getRegions = (0, _helpers.catchAsync)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
  var data;
  return _regeneratorRuntime().wrap(function _callee5$(_context5) {
    while (1) switch (_context5.prev = _context5.next) {
      case 0:
        _context5.next = 2;
        return (0, _helpers.AJAX)("get", "/api/v1/hotels/cities?fields=cityName,regionNames");
      case 2:
        data = _context5.sent;
...
var getProperties = (0, _helpers.catchAsync)( /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(searchQuery) {
    var region, sort, minDist, maxDist, star, offers, languages, limit, page, url, pro;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          region = searchQuery.region, sort = searchQuery.sort, minDist = searchQuery.minDist, maxDist = searchQuery.maxDist, star = searchQuery.star, offers = searchQuery.offers, languages = searchQuery.languages, limit = searchQuery.limit, page = searchQuery.page; //base url
          url = "/api/v1/hotels/hotels?minDist=".concat(minDist || _config.DEFAULT_MIN_DIST, "&maxDist=").concat(maxDist || _config.DEFAULT_MAX_DIST, "&sort=").concat(sort || _config.DEFAULT_SORT, "&limit=").concat(limit || _config.DEFAULT_PROPERTIES_LIMIT, "&page=").concat(page || 1, "&cityName=").concat(region || _config.DEFAULT_REGION);
          if (star) url += "&star=".concat(star);
          if (offers) url += "&offers=".concat(offers.replaceAll(" ", "-"));
          if (languages) url += "&languages=".concat(languages.replaceAll(" ", "-"));
          _context6.next = 7;
          return (0, _axios.default)({
            method: "get",
            url: url
        ...
        case 7:
          pro = _context6.sent;
          return _context6.abrupt("return", pro.data);
        case 9:
        case "end":
...
},{"./helpers":"helpers.js","./config.js":"config.js","axios":"../node_modules/axios/index.js"}],"views/view.js":[function(require,module,exports) {
"use strict";
...
var View = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
    key: "removeLoadingSpinner",
    value: function removeLoadingSpinner(item) {
      item.querySelector(".lds-ring").remove();
    }
  }, {
    key: "addLoadingSpinner",
    value: function addLoadingSpinner(item) {
